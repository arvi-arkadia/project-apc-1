...
<main id="main">
    ...
    <div class="container mt-12" style="width: 100%; margin: 0 auto;max-width: 350px;padding: 15px;padding-top: 20%;border: 0px solid #d8dee2;background-color: white;">
        <div class="mt-3">
    ...
    <div class="mt-3">
        <div style="width: 100%; margin: 0 auto;max-width: 350px;padding: 15px;padding-bottom:10%;border: 0px solid #d8dee2;
